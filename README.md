...
This repository was created just for me to store the vector files as SVGs and present them in a more accessible manner.
The original source download provides only rasterised PNG files (which are not as high quality or scalable), and 
vector diagrams in a proprietary Adobe Animator `.fla` file, which I found painful to parse and get data from.

Hopefully this is useful to somebody else as well.
